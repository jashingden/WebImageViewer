package com.example.webcrawler.data.repository

import com.example.webcrawler.data.crawler.CrawlData
import com.example.webcrawler.data.crawler.CrawlEntryData
import com.example.webcrawler.data.crawler.WebCrawler
...
class CrawlerRepositoryTest {
    ...
    fun `givenIndexId_whenGetEntriesAsContentItems_thenReturnsMappedItems`() = runBlocking {
        val entries = listOf(
            com.example.webcrawler.data.model.LinkEntry(
                id = 1L,
                linkIndexId = 1L,
