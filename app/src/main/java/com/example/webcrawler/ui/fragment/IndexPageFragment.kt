...
import com.example.webcrawler.data.model.ContentItem
import com.example.webcrawler.databinding.FragmentBrowsePageBinding
import com.example.webcrawler.ui.adapter.ContentAdapter
...
class IndexPageFragment : Fragment() {
    ...
    private val viewModel: com.example.webcrawler.ui.viewmodel.BrowseViewModel by viewModels()
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.pageState.collect { state ->
                    when (state) {
                        is com.example.webcrawler.ui.viewmodel.PageState.Success -> {
